...
import com.moviechecker.data.source.DataRecord
import com.moviechecker.data.source.EpisodeData
import com.moviechecker.data.source.MovieData
import com.moviechecker.data.source.SeasonData
import com.moviechecker.data.source.SiteData
import com.moviechecker.database.episodes.EpisodeDao
import com.moviechecker.database.episodes.EpisodeEntity
import com.moviechecker.database.episodes.EpisodeState
import com.moviechecker.database.episodes.EpisodeView
...
import com.moviechecker.database.sites.SiteDao
import com.moviechecker.database.sites.SiteEntity
import com.moviechecker.workers.RetrieveDataWorker
                    ...
                    .addCallback(object : Callback() {
                        ...
                        override fun onOpen(db: SupportSQLiteDatabase) {
                            ...
                            WorkManager.getInstance(context)
                                .enqueue(OneTimeWorkRequestBuilder<RetrieveDataWorker>().build())
                        }
                    })
                    .build()
                    .also {
